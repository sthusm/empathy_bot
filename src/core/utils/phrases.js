...
const ASK_REPLY = `
Напишите текст запроса. Расскажите о том, что вам нужна эмпатия, тему на которую хотели бы поговорить и интенсивность переживемых эмоций по шкале от 1 до 10.
